    ...
    return (
      ...
      >
                ...
                {this.state.processes.map((item, index) => (
                  ...
                  c3.1,5.4,8.9,8.8,15.2,8.8h151.7c6.3,0,12-3.3,15.2-8.8s3.1-12.1,0-17.5C344.5,207.7,338.8,204.3,332.5,204.3z"
                          ...
                          <div className="my-4 w-[90%]">
                            <div className="mb-[0.125rem] truncate">
                              {item.name}
                            </div>
                          ...
                          <div className="process-icons">
                            <div
                              ...
                              onClick={(e) => {
                                ...
                                ;(async () => {
                                  try {
                                    if (item.status === 0) {
                                      await window.go.main.App.RunProcess(
                                        item.id
                                      )
                                    } else {
                                      await window.go.main.App.StopProcess(
                                        item.id
                                      )
                                    }
                                    this.setState((st) => {
                            ...
                            <div
                              ...
                              onClick={(e) => {
                                e.stopPropagation()
                                this.props.navigate("/edit-process", {
                                  state: item,
                                })
                              }}
                            >
                            ...
                            <div
                              ...
                              onClick={(e) => {
                                ...
                                ;(async () => {
                                  try {
                                    await window.go.main.App.DeleteProcess(
                                      item.id
                                    )
                                    this.setState((st) => {
                                      return {
        ...
        <div
          ...
          className="btn-floating fixed right-8 bottom-8"
          onClick={(e) => {
            e.stopPropagation()
            this.props.navigate("/new-process")
          }}
